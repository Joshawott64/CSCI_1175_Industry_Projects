 ...
 * Date: 11/9/21
 * 
 * This program modifies TabPaneDemo.java to add a pane of radio buttons 
 * for specifying the tab placement of the tab pane.
 */
...
public class TabPaneDemo extends Application {   
  ...
  public void start(Stage primaryStage) {   
    ...
    BorderPane paneForRadioButtons = new BorderPane();
    ...
    HBox boxForRadioButtons = new HBox(5);
    boxForRadioButtons.getChildren().addAll(rbTop, rbLeft, rbBottom, rbRight);
    
    paneForRadioButtons.setBottom(boxForRadioButtons);
    paneForRadioButtons.setCenter(tabPane);
    ...
    Scene scene = new Scene(paneForRadioButtons, 300, 250);
